...
use crate::state::{TRANSFER_AUTHORITY_SEED, XUSDC_MINT_KEY};
...
pub struct Deposit<'info> {
    ...
    pub xusdc_global_ata: InterfaceAccount<'info, TokenAccount>,
    ...
    token_2022::transfer_checked(
        CpiContext::new(
            ...
            token_2022::TransferChecked {
                ...
                to: ctx.accounts.xusdc_global_ata.to_account_info(),
